            ...
            <tbody>
                <?php
                    ...
                    $sql = "Select *
                            ...
                            WHERE o.picked_up = 1 and os.order_no = o.order_no";
                        ...
                        while($row=mysqli_fetch_assoc($result)){
                            ...
                            if ($type == "Food") {
                                ...
                                echo '<tr>
                                    ...
                                    <td>'.$date.' '.$time.'</td>
                                    <td>'.$type.'</td>
                                    <td> <a href="backemp-preview-corder.php?ordNo='.$orderNo.'&page=complete" class="btn btn-secondary">Preview Order</a>    
                                    </td>
                                </tr>
                                ';
                            }
