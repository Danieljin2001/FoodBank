...
<html lang="en">
  ...
  <body>
    ...
    <h1 class="text-center mt-5">Incomplete Orders</h1> 
            ...
            <tbody>
                <?php
                    ...
                    $sql = "Select *
                            ...
                            WHERE o.picked_up = 0 and o.Bemp_id='$user' and o.Ready_for_pick_up = 0 and os.order_no = o.order_no";
                        ...
                        while($row=mysqli_fetch_assoc($result)){
                            ...
                            if ($type == "Food") {
                              echo '<tr>
                                  ...
                                  <a href="backemp-complete-order.php?ordNo='.$orderNo.'" class="btn btn-primary">Complete order</a>
                                  </td>
                              </tr>
                              ';
                          } else {
