                    ...
                    if($result){
                        while($row=mysqli_fetch_assoc($result)){
                            ...
                            echo '<tr>
                                ...
                                <td>'.$bempId.'</td>
                                <td>'.$type.'</td>
                                <td> <a href="backemp-preview-forder.php?empId='.$user.'&ordNo='.$orderNo.' " class="btn btn-secondary">Preview Order</a>
                                <td> <a href="assign-order-back.php?empId='.$user.'&ordNo='.$orderNo.' " class="btn btn-secondary">Assign to me</a>
                                </td>
                            </tr>
                            ';
                        }
